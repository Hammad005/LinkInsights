...
export default function MyLinks() {
  ...
  const handleViewOrder = (shortCode) => {
          ...
          <table className="w-full ">
            ...
            <tbody>
              {currentLinks.map((order) => {
                ...
                const sortedUrl = import.meta.env.VITE_BASE_URL+order.shortCode
                return (
                  <tr
                    key={order.shortCode}
                  ...
                  >
                    <td className="py-4 px-6">
                      <Link to={order.originalUrl} target="_blank" className="underline font-medium text-gray-800">
                        {order.originalUrl.length > 38 ? `${order.originalUrl.slice(0, 38)}...` : order.originalUrl}
                      </Link>
                    </td>
                    <td className="py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <Link to={sortedUrl} target="_blank" className="underline font-medium text-gray-800">
                        {sortedUrl.length > 38 ? `${sortedUrl.slice(0, 38)}...` : sortedUrl}
                      </Link>
                    </td>
                    <td className="py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          onClick={() => handleViewOrder(order.shortCode)}
